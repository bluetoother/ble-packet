...
var hciCharMeta = {
   ...
   '0xcc00' : {
        params: ['flags', 'dInState'],
        types: ['uint8', 'boolean'],
        depends: {
            params: ['counter', 'dInPolarity', 'debouncePeriod', 'edgeSelection', 'counterReset', 'appType', 'sensorType'],
            types: ['uint8', 'boolean', 'uint16', 'uint8', 'bufferPreLenUint8', 'stringPreLenUint8', 'stringPreLenUint8']
        }
    },
    '0xcc01' : {
        params: ['flags', 'dOutState'],
        types: ['uint8', 'boolean'],
        depends: {
            params: ['dOutPolarity', 'appType'],
            types: ['boolean', 'stringPreLenUint8']
        }
    },
    '0xcc02' : {
        params: ['flags', 'aInCurrValue'],
        types: ['uint8', 'floatle'],
        depends: {
            params: ['minMeaValue', 'maxMeaValue', 'minRangeValue', 'maxRangeValue', 'resetMinMaxMeaValues', 'appType', 'sensorType'],
            types: ['floatle', 'floatle', 'floatle', 'floatle', 'bufferPreLenUint8', 'stringPreLenUint8', 'stringPreLenUint8']
        }
    },
    '0xcc03' : {
        params: ['flags', 'aOutCurrValue'],
        types: ['uint8', 'floatle'],
        depends: {
            params: ['minRangeValue', 'maxRangeValue', 'appType'],
            types: ['floatle', 'floatle', 'stringPreLenUint8']
        }
    },
    '0xcc04' : {
        params: ['flags', 'sensorValue'],
        types: ['uint8', 'floatle'],
        depends: {
            params: ['units', 'minMeaValue', 'maxMeaValue', 'minRangeValue', 'maxRangeValue', 'resetMinMaxMeaValues', 'appType', 'sensorType'],
            types: ['stringPreLenUint8', 'floatle', 'floatle', 'floatle', 'floatle', 'bufferPreLenUint8', 'stringPreLenUint8', 'stringPreLenUint8']
        }
    },
    '0xcc05' : {
        params: ['flags', 'sensorValue'],
        types: ['uint8', 'floatle'],
        depends: {
            params: ['units', 'minMeaValue', 'maxMeaValue', 'minRangeValue', 'maxRangeValue', 'resetMinMaxMeaValues'],
            types: ['stringPreLenUint8', 'floatle', 'floatle', 'floatle', 'floatle', 'bufferPreLenUint8']
        }
    },
    '0xcc06' : {
        params: ['flags', 'dInState'],
        types: ['uint8', 'boolean'],
        depends: {
            params: ['counter', 'counterReset', 'sensorType', 'busyToClearDelay', 'clearToBusyDelay'],
            types: ['uint8', 'bufferPreLenUint8', 'stringPreLenUint8', 'uint16', 'uint16']
        }
    },
    '0xcc07' : {
        params: ['flags', 'sensorValue'],
    ...
    '0xcc09' : {
        params: ['flags', 'instActivePwr'],
        types: ['uint32', 'floatle'],
        depends: {
            params: ['minMeaActivePwr', 'maxMeaActivePwr', 'minRangeActivePwr', 'maxRangeActivePwr', 'cumulActivePwr', 'activePwrCal', 'instReactivePwr', 'minMeaReactivePwr', 'maxMeaReactivePwr', 'minRangeReactivePwr', 'maxRangeReactivePwr', 'resetMinMaxMeaValues', 'cumulReactivePwr', 'reactivePwrCal', 'pwrFactor', 'currCal', 'resetCumulEnergy'],
            types: ['floatle', 'floatle', 'floatle', 'floatle', 'floatle', 'floatle', 'floatle', 'floatle', 'floatle', 'floatle', 'floatle', 'bufferPreLenUint8', 'floatle', 'floatle', 'floatle', 'floatle', 'bufferPreLenUint8']
        }
    },
    '0xcc0a' : {
        params: ['flags', 'onOff'],
        types: ['uint8', 'boolean'],
        depends: {
            params: ['dimmer', 'onTime', 'mStateOut', 'appType'],
            types: ['uint8', 'uint16', 'stringPreLenUint8', 'stringPreLenUint8']
        }
    },
    '0xcc0b' : {
        params: ['flags', 'setPointValue'],
        types: ['uint8', 'floatle'],
        depends: {
            params: ['colour', 'units', 'appType'],
            types: ['stringPreLenUint8', 'stringPreLenUint8', 'stringPreLenUint8']
        }
    },
    '0xcc0c' : {
        params: ['flags', 'eventId', 'startTime', 'durationInMin'],
        types: ['uint8', 'stringPreLenUint8', 'uint32', 'uint16'],
        depends: {
            params: ['criticalLevel', 'avgLoadAdjPct', 'dutyCycle'],
            types: ['uint8', 'uint8', 'uint8']
        }
    },
    '0xcc0d' : {
        ...
        types: ['uint8', 'boolean'],
        depends: {
            params: ['dimmer', 'colour', 'units', 'onTime', 'cumulActivePwr', 'pwrFactor'],
            types: ['uint8', 'stringPreLenUint8', 'stringPreLenUint8', 'uint16', 'floatle', 'floatle']
        }
    },
    '0xcc0e' : {
        params: ['flags', 'onOff'],
        types: ['uint8', 'boolean'],
        depends: {
            params: ['dimmer', 'onTime', 'cumulActivePwr', 'pwrFactor'],
            types: ['uint8', 'uint16', 'floatle', 'floatle']
        }
    },
    '0xcc0f' : {
        params: ['flags', 'xValue'],
        types: ['uint8', 'floatle'],
        depends: {
            params: ['yValue', 'zValue', 'units', 'minRangeValue', 'maxRangeValue'],
            types: ['floatle', 'floatle', 'stringPreLenUint8', 'floatle', 'floatle']
        }
    },
    '0xcc10' : {
        params: ['flags', 'xValue'],
        types: ['uint8', 'floatle'],
        depends: {
            params: ['yValue', 'zValue', 'units', 'compassDir'],
            types: ['floatle', 'floatle', 'stringPreLenUint8', 'floatle']
        }
    },
    '0xcc11' : {
        params: ['flags', 'sensorValue'],
